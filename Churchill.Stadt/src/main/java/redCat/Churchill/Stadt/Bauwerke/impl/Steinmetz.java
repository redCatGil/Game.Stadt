...
public class Steinmetz extends Guetergebaeude {
	
	private final String DSN = "ressource/main/xml/steinmetz1.xml";
...
//		2 Tage
	 ...
	 * @param gebaeude_art
	 */
	public Steinmetz(GregorianCalendar bauzeit, Integer breite, Integer diamanten, Integer laenge, Integer muenzen,
	 ...
	 * @param gebaeude_art
	 */
	public Steinmetz(String name, String zeitalter, int muenzen, int werkzeug, int personen, int diamanten,
