...
public class Arbeiterhaus extends Wohngebaeude {
	
	private final String DSN = "ressource/main/xml/arbeiterhaus1.xml";
	...
	public Arbeiterhaus(String name, String zeitalter, int muenzen, int werkzeug, int diamanten, int laenge, int breite,
