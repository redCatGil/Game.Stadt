...
public class Gerberei extends Produktionsgebaeude {
	
	private final String DSN = "ressource/main/xml/gerberei1.xml";
	...
	public Gerberei(String name, String zeitalter, int muenzen, int werkzeug,
