...
public class ViktorianischesHaus extends Wohngebaeude {
	
	private final String DSN = "ressource/main/xml/viktorianisches_haus1.xml";

	public ViktorianischesHaus() {
		super();
	...
	public ViktorianischesHaus(String name, String zeitalter, int muenzen, int werkzeug, int diamanten, int laenge, int breite,
