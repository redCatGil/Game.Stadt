...
public class Faerberei extends Guetergebaeude {
	
	private final String DSN = "ressource/main/xml/faerberei1.xml";

	/**
	 * Standardkonstruktor für die Färberei
	 * Die Werte werden alle aus dem Standard-XML für die Färberei übernommen
	 */
	public Faerberei() {
...
//		2 Tage
	...
	/**
	 * Konstruktor bei dem die Färberei mit den übergebenen Werten aufgebaut wird.
	 ...
	 * @param gebaeude_art
	 */
	public Faerberei(GregorianCalendar bauzeit, Integer breite, Integer diamanten, Integer laenge, Integer muenzen,
	 ...
	 * @param gebaeude_art
	 */
	public Faerberei(String name, String zeitalter, int muenzen, int werkzeug, int personen, int diamanten,
