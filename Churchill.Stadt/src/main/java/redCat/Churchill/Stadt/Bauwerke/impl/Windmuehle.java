...
public class Windmuehle extends Produktionsgebaeude {
	
	private final String DSN = "ressource/main/xml/windmuehle1.xml";
	...
	public Windmuehle(String name, String zeitalter, int muenzen, int werkzeug,
