...
public class Mansarddach_Haus extends Wohngebaeude {
	
	private final String DSN = "ressource/main/xml/mansarddach_haus1.xml";

	public Mansarddach_Haus() {
		super();
	...
	public Mansarddach_Haus(String name, String zeitalter, int muenzen, int werkzeug, int diamanten, int laenge, int breite,
