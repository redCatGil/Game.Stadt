...
public class Residenz extends Wohngebaeude {
	
	private final String DSN = "ressource/main/xml/residenz1.xml";
	...
	public Residenz(String name, String zeitalter, int muenzen, int werkzeug, int diamanten, int laenge, int breite,
