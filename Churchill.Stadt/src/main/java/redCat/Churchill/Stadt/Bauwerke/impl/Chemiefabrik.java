...
public class Chemiefabrik extends Produktionsgebaeude {
	
	private final String DSN = "ressource/main/xml/chemiefabrik1.xml";
	...
	public Chemiefabrik() {
		...
		try {
			...
			System.out.println("Bauzeit-Chemiefabrik: " + this.getpBauzeit().toString());
	...
	public Chemiefabrik(String name, String zeitalter, int muenzen, int werkzeug,
