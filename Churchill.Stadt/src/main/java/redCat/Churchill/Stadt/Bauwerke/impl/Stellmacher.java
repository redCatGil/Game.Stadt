...
public class Stellmacher extends Produktionsgebaeude {
	
	private final String DSN = "ressource/main/xml/stellmacher1.xml";
	...
	public Stellmacher() {
		...
		try {
			...
			System.out.println("Bauzeit-Stellmacher: " + this.getpBauzeit().toString());
	...
	public Stellmacher(String name, String zeitalter, int muenzen, int werkzeug,
