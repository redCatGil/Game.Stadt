...
public class Baeckerei extends Produktionsgebaeude {
	
	private final String DSN = "ressource/main/xml/baeckerei1.xml";
	...
	public Baeckerei(String name, String zeitalter, int muenzen, int werkzeug,
