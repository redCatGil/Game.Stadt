...
public class Ziegenzucht extends Produktionsgebaeude {
	
	private final String DSN = "ressource/main/xml/ziegenzucht1.xml";
	...
	public Ziegenzucht(String name, String zeitalter, int muenzen, int werkzeug,
