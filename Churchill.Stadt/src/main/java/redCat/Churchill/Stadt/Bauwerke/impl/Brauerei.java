...
public class Brauerei extends Produktionsgebaeude {
	
	private final String DSN = "ressource/main/xml/brauerei1.xml";
	...
	public Brauerei(String name, String zeitalter, int muenzen, int werkzeug,
