...
public class Gewuerzhandlung extends Produktionsgebaeude {
	
	private final String DSN = "ressource/main/xml/gewuerzhandlung1.xml";

	public Gewuerzhandlung() {
	...
	public Gewuerzhandlung(String name, String zeitalter, int muenzen, int werkzeug,
