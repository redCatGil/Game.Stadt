...
public class Weberei extends Guetergebaeude {
	
	private final String DSN = "ressource/main/xml/weberei1.xml";

	/**
	 * Standardkonstruktor für die Weberei
	 * Die Werte werden alle aus dem Standard-XML für die Weberei übernommen
	 */
	public Weberei() {
...
//		2 Tage
	...
	/**
	 * Konstruktor bei dem die Weberei mit den übergebenen Werten aufgebaut wird.
	 ...
	 * @param gebaeude_art
	 */
	public Weberei(GregorianCalendar bauzeit, Integer breite, Integer diamanten, Integer laenge, Integer muenzen,
	 ...
	 * @param gebaeude_art
	 */
	public Weberei(String name, String zeitalter, int muenzen, int werkzeug, int personen, int diamanten,
