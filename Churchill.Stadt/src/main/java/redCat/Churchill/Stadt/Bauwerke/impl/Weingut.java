...
public class Weingut extends Guetergebaeude {
	
	private final String DSN = "ressource/main/xml/weingut1.xml";

	/**
	 * Standardkonstruktor für das Weingut
	 * Die Werte werden alle aus dem Standard-XML für das Weingut übernommen
	 */
	public Weingut() {
...
//		2 Tage
	...
	/**
	 * Konstruktor bei dem das Weingut mit den übergebenen Werten aufgebaut wird.
	 ...
	 * @param gebaeude_art
	 */
	public Weingut(GregorianCalendar bauzeit, Integer breite, Integer diamanten, Integer laenge, Integer muenzen,
	 ...
	 * @param gebaeude_art
	 */
	public Weingut(String name, String zeitalter, int muenzen, int werkzeug, int personen, int diamanten,
