...
public class Ebenholzwerkstatt extends Guetergebaeude {
	
	private final String DSN = "ressource/main/xml/ebenholzwerkstatt1.xml";

	/**
	 * Standardkonstruktor für den Juwelier
	 * Die Werte werden alle aus dem Standard-XML für die Ebenholz-Werkstatt übernommen
	 */
	public Ebenholzwerkstatt() {
...
//		2 Tage
	...
	/**
	 * Konstruktor bei dem die Ebenholz-Werkstatt mit den übergebenen Werten aufgebaut wird.
	 ...
	 * @param gebaeude_art
	 */
	public Ebenholzwerkstatt(GregorianCalendar bauzeit, Integer breite, Integer diamanten, Integer laenge, Integer muenzen,
	 ...
	 * @param gebaeude_art
	 */
	public Ebenholzwerkstatt(String name, String zeitalter, int muenzen, int werkzeug, int personen, int diamanten,
