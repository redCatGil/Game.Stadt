...
public class Pension extends Wohngebaeude {
	
	private final String DSN = "ressource/main/xml/pension1.xml";
	...
	public Pension(String name, String zeitalter, int muenzen, int werkzeug, int diamanten, int laenge, int breite,
