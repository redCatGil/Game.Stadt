...
public class Schneiderei extends Produktionsgebaeude {
	
	private final String DSN = "ressource/main/xml/schneiderei1.xml";
	...
	public Schneiderei(String name, String zeitalter, int muenzen, int werkzeug,
