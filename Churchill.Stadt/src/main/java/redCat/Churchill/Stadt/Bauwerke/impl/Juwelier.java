...
public class Juwelier extends Guetergebaeude {
	
	private final String DSN = "ressource/main/xml/juwelier1.xml";

	/**
	 * Standardkonstruktor für den Juwelier
	 * Die Werte werden alle aus dem Standard-XML für den Juwelier übernommen
	 */
	public Juwelier() {
...
//		2 Tage
	...
	/**
	 * Konstruktor bei dem der Juwelier mit den übergebenen Werten aufgebaut wird.
	 ...
	 * @param gebaeude_art
	 */
	public Juwelier(GregorianCalendar bauzeit, Integer breite, Integer diamanten, Integer laenge, Integer muenzen,
	 ...
	 * @param gebaeude_art
	 */
	public Juwelier(String name, String zeitalter, int muenzen, int werkzeug, int personen, int diamanten,
