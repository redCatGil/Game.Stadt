...
public class Tabakplantage extends Produktionsgebaeude {
	
	private final String DSN = "ressource/main/xml/tabakplantage1.xml";
	private static SimpleDateFormat sdf = new SimpleDateFormat("dd.MM.yyyy HH:mm:ss");

	public Tabakplantage() {
	...
	public Tabakplantage(String name, String zeitalter, int muenzen, int werkzeug,
