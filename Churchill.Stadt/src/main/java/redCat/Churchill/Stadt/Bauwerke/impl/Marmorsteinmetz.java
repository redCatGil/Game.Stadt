...
public class Marmorsteinmetz extends Guetergebaeude {
	
	private final String DSN = "ressource/main/xml/marmorsteinmetz1.xml";

	public Marmorsteinmetz() {
...
//		2 Tage
	 ...
	 * @param gebaeude_art
	 */
	public Marmorsteinmetz(GregorianCalendar bauzeit, Integer breite, Integer diamanten, Integer laenge, Integer muenzen,
	 ...
	 * @param gebaeude_art
	 */
	public Marmorsteinmetz(String name, String zeitalter, int muenzen, int werkzeug, int personen, int diamanten,
