...
public class Kalksteinmetz extends Guetergebaeude {
	
	private final String DSN = "ressource/main/xml/kalksteinmetz1.xml";

	/**
	 * Standardkonstruktor für den Kalksteinmetz
	 * Die Werte werden alle aus dem Standard-XML für den Kalksteinmetz übernommen
	 */
	public Kalksteinmetz() {
...
//		2 Tage
	...
	/**
	 * Konstruktor bei dem den Kalksteinmetz mit den übergebenen Werten aufgebaut wird.
	 ...
	 * @param gebaeude_art
	 */
	public Kalksteinmetz(GregorianCalendar bauzeit, Integer breite, Integer diamanten, Integer laenge, Integer muenzen,
	 ...
	 * @param gebaeude_art
	 */
	public Kalksteinmetz(String name, String zeitalter, int muenzen, int werkzeug, int personen, int diamanten,
