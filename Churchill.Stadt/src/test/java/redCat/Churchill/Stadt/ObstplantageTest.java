...
public class ObstplantageTest {
  ...
  @Test
  public void obstplantage_ist_normales_gebaeude() {
	  Assert.assertEquals(obstplantage.getGebaeude_art(), gebaeude_art);
	  Assert.assertEquals(obstplantage.getGebaeude_art(), "Normal");
  }
